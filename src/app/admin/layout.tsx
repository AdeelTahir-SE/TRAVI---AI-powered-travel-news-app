        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    <div className="inline-block animate-spin rounded-full h-12 w-12 border-4 border-[#F8A900] border-t-transparent" />
                    <p className="mt-4 font-manrope font-semibold text-[#112259]">Loading…</p>
                </div>
            </div>
        )
    }
    ...
    if (adminStatus === 'pending') {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-[24px] shadow-[9px_9px_75px_0px_#00000029] max-w-md w-full p-8 text-center">
                    <div className="w-16 h-16 rounded-full bg-amber-100 flex items-center justify-center mx-auto mb-4">
                        <svg className="w-8 h-8 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>
                    <h2 className="font-manrope font-extrabold text-[22px] tracking-tight text-[#112259] mb-2">Access Pending Approval</h2>
                    <p className="text-gray-500 text-sm leading-relaxed mb-6 font-inter">
                        Your admin account has been created. A super admin needs to approve your access before you can use the dashboard.
                    </p>
                    <button onClick={handleLogout} className="cursor-pointer text-sm text-gray-400 hover:text-[#112259] transition-colors font-inter underline">
                        Sign out
                    </button>
                </div>
            </div>
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-[24px] shadow-[9px_9px_75px_0px_#00000029] max-w-md w-full p-8 text-center">
                    ...
                    <h2 className="font-manrope font-extrabold text-[22px] tracking-tight text-[#112259] mb-2">Access Rejected</h2>
                    <p className="text-gray-500 text-sm leading-relaxed mb-6 font-inter">
