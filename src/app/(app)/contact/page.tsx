    ...
    return (
        <div className="flex flex-col items-center justify-center relative w-full">
            <section className="flex flex-col items-center justify-center w-full">
                ...
                {/* Text overlay */}
                <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center text-white z-10 text-center px-[20px] md:px-[40px] lg:px-[100px] gap-6">
                    {/* Breadcrumb pill */}
                    <div className="py-[12px] px-[24px] rounded-[600px] bg-[rgba(132,140,151,0.55)]">
                    ...
                    <div className="relative flex flex-col items-center justify-center">
                        ...
                        <p className="font-inter font-normal text-[18px] lg:text-[22px] leading-[32px] tracking-[-0.02em] text-center z-10 max-w-2xl mt-2">
...
function InfoCard({ icon, label, value, href }: { icon: React.ReactNode; label: string; value: string; href?: string }) {
    const content = (
        <div className="flex flex-col items-center justify-center gap-4 bg-white rounded-[25px] shadow-[9px_9px_75px_0px_#00000029] px-8 py-10 w-full text-center hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="font-inter font-medium text-[14px] leading-[20px] tracking-[0.08em] uppercase text-gray-400">{label}</p>
            <p className="font-manrope font-extrabold text-[20px] lg:text-[22px] leading-[28px] tracking-[-0.03em] text-[#112259]">{value}</p>
        </div>
    )
...
function ContactInfo() {
    return (
        <section className="flex flex-col items-center justify-center px-[20px] py-[60px] lg:py-[80px] lg:px-[140px] gap-[50px]">
            ...
            <div className="flex flex-row items-stretch justify-center flex-wrap gap-[24px] w-full">
                <InfoCard
                    icon={
...
function ContactForm() {
    ...
    return (
        <section className="px-[20px] pb-[80px] lg:pb-[100px] lg:px-[140px]">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-[30px] shadow-[9px_9px_75px_0px_#00000029] p-8 sm:p-12 relative overflow-hidden">
                    ...
                    <div className="relative flex flex-col items-start gap-2 mb-10">
                        ...
                        <p className="font-inter font-normal text-[16px] lg:text-[20px] leading-[28px] tracking-[-0.02em] text-gray-500">
