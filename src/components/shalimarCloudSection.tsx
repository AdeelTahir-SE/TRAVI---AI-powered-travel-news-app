...
export default function ShalimarCloudSection({ className }: { className: string }) {
  return (
    <section
      className={` ${className} flex flex-row items-center justify-center  max-h-[600px] h-[200px] md:h-[250px] 2xl:h-[450px] *:min-h-[400px] *:min-w-[1200px] *:top-5 *:lg:top-20 *:2xl:top-[150px] `}
    >
