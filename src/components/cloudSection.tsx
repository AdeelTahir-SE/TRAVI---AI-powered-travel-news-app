...
export default function CloudImages(){
    return (
      <section className="overflow-hidden bg-gradient-to-b from-[#2384C8] via-[#3ca8f5] via-[#44adf8]  to-white max-h-[600px] h-[200px] md:h-[350px]  *:min-h-[400px] *:min-w-[1200px] ">
        <Image
