...
export default function ExploreActivitiesSection() {
  return (
    <section className="relative flex flex-col items-center justify-center ">
      <section className="relative flex flex-col items-center justify-center gap-[10px] py-[60px] lg:py-[100px] px-[20px] lg:px-[140px]">
        ...
        <p className="sub-heading color-[#1B1B1B] ">
      ...
      <TransparentCloudsSection className="absolute overflow-hidden w-full bottom-0 z-50 " />
