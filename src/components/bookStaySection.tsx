...
export default function BookStaySection(){
    return (
      <section className="relative flex items-center justify-center py-[60px] lg:py-[100px] lg:px-[70px] 2xl:px-[140px] px-[20px] min-w-full  min-h-[412px]">
        <div className="relative rounded-[32px] 2xl:rounded-[60px]">
          <Image
          ...
          <div className="absolute inset-0 py-[48px] px-[32px]  2xl:p-[72px]">
            <div className="flex flex-col items-center justify-center w-full h-full gap-[48px]">
              <div className="flex flex-col items-center justify-center text-center gap-[12px]">
                <h2 className="font-manrope font-extrabold text-[48px] lg:text-[72px] leading-[100%] tracking-[-0.03em] text-center text-white">Ready to Book Your Stay?</h2>
                <p className="font-manrope font-normal text-[24px] lg:text-[28px] leading-[100%] text-white tracking-[-0.03em]">Experience world-class luxury at Atlantis The Palm, Dubai</p>
              </div>
