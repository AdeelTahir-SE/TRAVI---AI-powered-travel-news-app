        ...
        <div className="space-y-3 ">
            ...
            <div className="flex items-center gap-3">
                <label className="cursor-pointer">
                    <div className="px-4 py-2 bg-[#F8A900] hover:bg-[#e09800] text-white rounded-lg font-medium transition-colors inline-flex items-center gap-2">
                ...
                {uploading && (
                    <div className="flex-1 max-w-xs">
                        <div className="w-full bg-gray-200 rounded-full h-2">
                            <div
                                className="bg-[#F8A900] hover:bg-[#e09800] h-2 rounded-full transition-all duration-300"
