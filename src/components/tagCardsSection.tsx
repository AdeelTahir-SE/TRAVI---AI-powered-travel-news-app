...
export default function TagCardsSection(){
    return (
      <section className="relative  flex flex-col items-center justify-center lg:gap-[80px] gap-[60px] px-[20px] md:px-[70px] py-[60px] 2xl:px-[140px] 2xl:py-[120px] w-full h-full">
        ...
        <div className="flex flex-col gap-[24px] lg:gap-0 lg:flex-row items-start justify-between w-full ">
          <span className="font-inter font-bold text-[22px] leading-[100%] tracking-[-0.02em]">24 resorts found</span>
